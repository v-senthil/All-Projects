...
#define FIREBASE_HOST "https://mrrobot-29a3f.firebaseio.com/"                          // the project name address from firebase id
#define FIREBASE_AUTH "lvzM8siKpBTNgeL8ea8qBrkngVfqRjgJnqFDCdwF"            // the secret key generated from firebase
...
void loop() { 
  ...
  if(GarbageLevel >= 60){
    Firebase.set("/Alerts/1111/Humidity", fireHumid);                                  //setup path and send readings
  Firebase.set("/Alerts/1111/Temperature", fireTemp);                              //setup path and send readings
